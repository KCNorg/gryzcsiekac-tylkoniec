...
ordercategory_enum = ENUM('GROCERIES', 'PET_WALKING', 'CONVERSATION', 'OTHER', name='ordercategory', native_enum=True)
...
def upgrade() -> None:
    ...
    op.alter_column(
        'orders',
        'category',
        existing_type=sa.dialects.postgresql.ENUM('SENIOR', 'VOLUNTEER', name='usertype'),
    ...
    op.alter_column('orders', 'category',
               ...
               type_=sa.Enum('GROCERIES', 'PET_WALKING', 'CONVERSATION', 'OTHER', name='ordercategory'),
               existing_nullable=False)
